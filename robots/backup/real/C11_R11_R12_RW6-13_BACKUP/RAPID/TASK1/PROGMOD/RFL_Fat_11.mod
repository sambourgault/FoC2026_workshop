MODULE RFL_Fat_11
	TASK PERS tooldata t_A073_wirecutter:=[TRUE,[[1.60459,55.7378,768.779],[1,0,0,0]],[10,[0,0,300],[1,0,0,0],0,0,0]];
	TASK PERS tooldata t_A073_Router:=[TRUE,[[-0.759485,-133.393,149.375],[0.573576,0.819152,0,0]],[2,[-1,-14,69],[1,0,0,0],0,0,0]];
    !***********************************************************************************
    !
