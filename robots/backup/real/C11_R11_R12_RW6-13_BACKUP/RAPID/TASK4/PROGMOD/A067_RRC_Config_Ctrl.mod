MODULE A067_RRC_Config_Ctrl
    ...
    PROC r_A067_RRC_Config()
        ...
        !
        ! Channel 3
        ch_RRC_Channels.Ch_3.T_Name:="";
        ch_RRC_Channels.Ch_3.Ch_Nr:=3;
        !
        ! Channel 4
        ch_RRC_Channels.Ch_4.T_Name:="";
        ch_RRC_Channels.Ch_4.Ch_Nr:=4;
        !
        ! IP Address
        b_RRC_AutoIPAddress:=TRUE;
        st_RRC_IP_AddressMan:="192.168.0.21";
        !
        ! Ports 
