MODULE RFL_Fat_12
    ...
    PROC rWorkspace()
        ...
        !
        ! Wait for Gantry11,21 X-Axis Max
    ...
    PROC rMultiMove()
        ...
        ! 
        ! Wait for ROB11 in posistion
        WaitSyncTask idETH_Fat5MMPosR11,tlAll;
        !
        ! Move ROB12 slow to Start point 
        MoveJ pMultMove,vMultiMoveMin,fine,tTeachTip\WObj:=obROB11;
        ! 
        ! Sync ROB12 in posistion and wait for ROB21, and ROB22 in posistion
